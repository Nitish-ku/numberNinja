...
const questions = [
  {
    ...
    solution: `
      ...
      area of rectangle : $$length\\times bredth$$<br>
      area of the rectangle 1 : $$5\\times 10 = 50m^2$$<br>
      area of the rectangle 2 : $$2\\times 7 = 14m^2$$<br>
      sum of the area of the rectangle 1 and rectangle 2 : $$50m^2+14m^2=64m^2$$<br>
      so, the total area of the rectangle : $$64m^2$$<br>
      let length of the unknown rectangle be x<br>
      let bredth of the unknown rectangle be y<br>
      area of the unknown rectangle = $$x\\times y$$<br>
      now, $$x\\times y=64$$<br>
      To find the dimension of the unknown rectangle we can find various pairs of length and bredth such that $$length\\times bredth=64m^2$$<br>
      Some possible dimensions could be :<br>
      $$1)\\ L = 16m,\\ W = 4m$$<br>
      $$2)\\ L = 32m,\\ W = 2m$$
    `,
  },
  {
    ...
    solution: `
      ...
      $$Area\\ of\\ the\\ garden(a) = length(l)\\times bredth(b)$$<br>
      $$a=l\\times b$$<br>
      $$b =\\frac{a}{l}$$<br>
      $$b =\\frac{1000}{50}=20m$$
    `,
  },
  {
    ...
    solution: `
      ...
      Now, subtract the carpet area from the floor’s area.<br>
      Area not carpeted = $$(20-9)m^2 = 11m^2$$
    `,
  },
  {
    id: "solution-4",
    ...
    solution: `
      ...
      Length of garden = $$15\\ m$$<br>
      Width of garden = $$12\\ m$$<br>
      Area of garden = $$15\\times 12 = 180\\ m^2$$<br>
      Area of one flower bed = $$2\\times 1 = 2m^2$$<br>
      Area of four flower beds = $$2\\times 4 = 8m^2$$<br>
  ...
  },
  {
    ...
    solution: `
      ...
      For Shape A:<br>
      Dimensions = $$1\\times 18$$<br>
      Area = $$18$$<br>
      Perimeter = $$2(1+18)=38$$<br>
      For Shape B:<br>
      Dimensions = $$4\\times 5$$<br>
      Area = $$20$$<br>
      Perimeter = $$2(4+5)=18$$<br>
      ✔ Shape A has longer perimeter, Shape B smaller perimeter.
    `,
  },
  {
    id: "solution-6",
    ...
    solution: `
      ...
      Perimeter of the border = $$2[length + width]$$<br>
      $$=2[1+1.5]$$<br>
      $$=2\\times 2.5$$<br>
      $$=5cm$$
    `,
  },
  {
    ...
    solution: `
      ...
      Area of given rectangle = $$12\\times 8 = 96$$<br>
      Half area = $$48$$<br>
      Possible sides: $$12\\times 4, 16\\times 3, 8\\times 6, 1\\times 48$$<br>
      ✔ Example: $$8\\times 6$$
    `,
  },
  {
    ...
    question: `
      <p>A square piece of paper is folded in half and cut. Which is true?</p>
      <p>a. Area of each rectangle is larger than the square</p>
      <p>b. Perimeter of square > perimeters of both rectangles added</p>
      <p>c. Perimeters of both rectangles added = 1.5 × perimeter of square</p>
      <p>d. Area of square = 3 × areas of both rectangles added</p>
    `,
    answers: ["c", "option c", "C"],
    solution: `
      <h5>Solution for Question 8</h5>
      The perimeters of both rectangles together are always 1.5× the perimeter of the square.<br>
      ✔ Option (C) is correct.
    `,
  },
];
